...
const GoogleLogin = () => {
    ...
    const initializeGoogleLogin = () => {
      ...
      setTimeout(() => {
        if (window.google && window.google.accounts) {
          try {
            // ★★★ 重要 ★★★
            // 実際のGoogleクライアントIDを設定してください
            const clientId = '647090775844-hlv5firan96f9augrh35mtheoboa786l.apps.googleusercontent.com';
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 space-y-4">
      <h2 className="text-2xl font-bold">Google カレンダー連携</h2>
